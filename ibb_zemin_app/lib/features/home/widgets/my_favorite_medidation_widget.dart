...
class MyFavoriteMedidationWidget extends StatelessWidget {
  MyFavoriteMedidationWidget({
    Key? key,
    required this.size,
  }) : super(key: key);

  final Size size;
  List<MedidationModel> medidations =
      MedidationTemps().getFavoriteMedidationList();
